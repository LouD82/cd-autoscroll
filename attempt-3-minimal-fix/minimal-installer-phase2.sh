...
# Claude Desktop Auto-Scroll Fix Installer (Minimal Version - Phase 2)
# This script automatically patches the Claude Desktop app with a minimal auto-scrolling fix

# Exit on any error
set -e

echo "Claude Desktop Auto-Scroll Fix Installer (Minimal Version - Phase 2)"
echo "--------------------------------------------------------"
...
echo "Copying phase 2 auto-scroll script..."
cp "$BASE_DIR/attempt-3-minimal-fix/minimal-autoscroll-phase2.js" "$BASE_DIR/attempt-3-minimal-fix/extracted/minimal-autoscroll.js"
...
echo ""
echo "✅ Minimal auto-scroll fix (Phase 2) successfully installed!"
echo ""
echo "This version inspects DOM elements but doesn't modify anything."
echo "To check if it works:"
echo "1. Restart Claude Desktop"
echo "2. Open the developer console (View > Developer > Toggle Developer Tools)"
echo "3. Look for messages about found scrollable elements"
echo ""
echo "If this works without crashing, we can proceed to phase 3."
