...
# Claude Desktop Auto-Scroll Fix Uninstaller (Minimal Version)
# This script restores the original Claude Desktop app.asar file

# Exit on any error
set -e

echo "Claude Desktop Auto-Scroll Fix Uninstaller (Minimal Version)"
echo "--------------------------------------------------------"

# Check if backup directory exists
BACKUP_DIR="$HOME/Dropbox/FCPS/Dev/claude-autoscroll-fix/backup"
