...
# Claude Desktop Auto-Scroll Fix Installer (Minimal Version - Phase 1)
# This script automatically patches the Claude Desktop app with a minimal auto-scrolling fix

# Exit on any error
set -e

echo "Claude Desktop Auto-Scroll Fix Installer (Minimal Version - Phase 1)"
echo "--------------------------------------------------------"
...
echo "Copying minimal auto-scroll script..."
cp "$BASE_DIR/attempt-3-minimal-fix/minimal-autoscroll-phase1.js" "$BASE_DIR/attempt-3-minimal-fix/extracted/minimal-autoscroll.js"
...
echo ""
echo "✅ Minimal auto-scroll fix (Phase 1) successfully installed!"
echo ""
echo "This is a test version that only logs a message to the console."
echo "To check if it works:"
echo "1. Restart Claude Desktop"
echo "2. Open the developer console (View > Developer > Toggle Developer Tools)"
echo "3. Look for the message: 'Auto-scroll fix: Minimal initialization successful'"
echo ""
echo "If this works without crashing, we can proceed to phase 2."
